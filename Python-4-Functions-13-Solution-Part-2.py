...
def fizz_buzz(input):
    ...
    # if input evenly divisible by 3 and 5, return the string "Fizz Buzz"
    if (input % 3 == 0) and (input % 5 == 0):
        # not if this line is last code block, and it's true, code on line 3 or 5 will print first...
        return "Fizz Buzz"
        # and code stops being executed
